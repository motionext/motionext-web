export default {
  ...
  emails: {
    ...
    passwordReset: {
      ...
      greeting: "Bonjour,",
      message: "Votre mot de passe a été réinitialisé avec succès. Vous pouvez maintenant vous connecter à votre compte avec votre nouveau mot de passe.",
      securityNotice: "Si vous n'avez pas demandé cette réinitialisation de mot de passe, veuillez contacter immédiatement notre équipe d'assistance car votre compte pourrait être compromis.",
      loginButtonText: "Se Connecter à Votre Compte",
      thankyou: "Merci",
      team: "L'Équipe de Sécurité Motionext",
      footer: "Ceci est une notification automatique du Système de Sécurité Motionext.",
    ...
    ticketResponseNotification: {
      ...
      ticketId: "ID du Ticket",
      attachmentsIncluded: "Des pièces jointes ont été incluses avec cette réponse.",
      viewTicket: "Voir le Ticket",
    ...
    ticketStatusNotification: {
      ...
      poweredBy: "Système de Support Motionext",
      copyright: "Tous droits réservés.",
      resolvedMessage: "Votre ticket a été marqué comme résolu. Si vous avez d'autres questions ou si le problème se reproduit, vous pouvez toujours répondre à ce ticket.",
      closedMessage: "Votre ticket a été clôturé. Merci d'avoir utilisé notre système de support. Si vous avez besoin d'une assistance supplémentaire, veuillez créer un nouveau ticket.",
    },
  },
  ticketForm: {
