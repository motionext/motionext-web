export default {
  ...
  auth: {
    ...
    accountActivated: "Compte activé avec succès. Vous pouvez maintenant vous connecter.",
    ...
    resetPasswordCheckEmail: "Veuillez vérifier votre email pour un lien pour réinitialiser votre mot de passe.",
    backToSignIn: "Retour à la Connexion",
    sendResetLink: "Envoyer le lien de réinitialisation",
    rememberPassword: "Vous avez oublié votre mot de passe ?",
    forgotPasswordDescription: "Entrez votre email ci-dessous pour recevoir un lien pour réinitialiser votre mot de passe.",
